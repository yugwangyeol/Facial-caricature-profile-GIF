...
class PNP(nn.Module):
    ...
    def load_lora(self):
        ...
        for lora_name in self.lora_name_list:
            ...
            load_lora_paths = '/content/drive/MyDrive/2024_ADV_Toy/DiffStyler/lora_models/' + lora_name.strip() + '.ckpt'
        ...
        for mask_name in self.mask_name_list:
            mask_path = '/content/drive/MyDrive/2024_ADV_Toy/DiffStyler/mask/'+ mask_name.strip() + '.png'
            mask = cv2.imread(mask_path)
            mask = cv2.resize(mask,[64,82])
