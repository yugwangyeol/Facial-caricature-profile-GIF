...
from DiffStyler.pnp_utils_combine import *
...
def run_gradio(data_path):
    ...
    save_path = os.path.join(save_dir + extraction_path_prefix, os.path.splitext(os.path.basename(data_path))[0])
    os.makedirs(save_path, exist_ok=True)

    model = Preprocess(device, sd_version=sd_version, hf_key=None)
